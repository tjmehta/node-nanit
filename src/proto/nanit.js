...
export const client = $root.client = (() => {
    ...
    client.SensorData = (function() {
        ...
        SensorData.decode = function decode(reader, length) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.client.SensorData();
        ...
        SensorData.fromObject = function fromObject(object) {
            if (object instanceof $root.client.SensorData)
                return object;
            let message = new $root.client.SensorData();
    ...
    client.GetSensorData = (function() {
        ...
        GetSensorData.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.client.GetSensorData();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        GetSensorData.fromObject = function fromObject(object) {
            if (object instanceof $root.client.GetSensorData)
                return object;
            let message = new $root.client.GetSensorData();
            if (object.all != null)
    ...
    client.Control = (function() {
        ...
        Control.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.client.Control();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 5: {
        ...
        Control.verify = function verify(message) {
            ...
            if (message.sensorDataTransfer != null && message.hasOwnProperty("sensorDataTransfer")) {
                let error = $root.client.Control.SensorDataTransfer.verify(message.sensorDataTransfer);
                if (error)
        ...
        Control.fromObject = function fromObject(object) {
            if (object instanceof $root.client.Control)
                return object;
            let message = new $root.client.Control();
        ...
        Control.SensorDataTransfer = (function() {
            ...
            SensorDataTransfer.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.client.Control.SensorDataTransfer();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            SensorDataTransfer.fromObject = function fromObject(object) {
                if (object instanceof $root.client.Control.SensorDataTransfer)
                    return object;
                let message = new $root.client.Control.SensorDataTransfer();
    ...
    client.Settings = (function() {
        ...
        Settings.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.client.Settings();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 2: {
        ...
        Settings.verify = function verify(message) {
            ...
            if (message.sensors != null && message.hasOwnProperty("sensors")) {
                ...
                for (let i = 0; i < message.sensors.length; ++i) {
                    let error = $root.client.Settings.SensorSettings.verify(message.sensors[i]);
                    if (error)
            ...
            if (message.streams != null && message.hasOwnProperty("streams")) {
                ...
                for (let i = 0; i < message.streams.length; ++i) {
                    let error = $root.client.Settings.StreamSettings.verify(message.streams[i]);
                    if (error)
        ...
        Settings.fromObject = function fromObject(object) {
            if (object instanceof $root.client.Settings)
                return object;
            let message = new $root.client.Settings();
        ...
        Settings.toObject = function toObject(message, options) {
            ...
            if (message.sensors && message.sensors.length) {
                object.sensors = [];
                for (let j = 0; j < message.sensors.length; ++j)
        ...
        Settings.SensorSettings = (function() {
            ...
            SensorSettings.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.client.Settings.SensorSettings();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            SensorSettings.fromObject = function fromObject(object) {
                if (object instanceof $root.client.Settings.SensorSettings)
                    return object;
                let message = new $root.client.Settings.SensorSettings();
                switch (object.sensorType) {
                default:
                    if (typeof object.sensorType === "number") {
                        message.sensorType = object.sensorType;
        ...
        Settings.StreamSettings = (function() {
            ...
            StreamSettings.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.client.Settings.StreamSettings();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            StreamSettings.fromObject = function fromObject(object) {
                if (object instanceof $root.client.Settings.StreamSettings)
                    return object;
                let message = new $root.client.Settings.StreamSettings();
                switch (object.id) {
                default:
    ...
    client.Status = (function() {
        ...
        Status.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.client.Status();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        Status.fromObject = function fromObject(object) {
            if (object instanceof $root.client.Status)
                return object;
            let message = new $root.client.Status();
    ...
    client.Playback = (function() {
        ...
        Playback.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.client.Playback();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        Playback.fromObject = function fromObject(object) {
            if (object instanceof $root.client.Playback)
                return object;
            let message = new $root.client.Playback();
    ...
    client.Stream = (function() {
        ...
        Stream.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.client.Stream();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        Stream.fromObject = function fromObject(object) {
            if (object instanceof $root.client.Stream)
                return object;
            let message = new $root.client.Stream();
            switch (object.type) {
            default:
    ...
    client.Streaming = (function() {
        ...
        Streaming.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.client.Streaming();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        Streaming.fromObject = function fromObject(object) {
            if (object instanceof $root.client.Streaming)
                return object;
            let message = new $root.client.Streaming();
            switch (object.id) {
            default:
                if (typeof object.id === "number") {
                    message.id = object.id;
    ...
    client.GetLogs = (function() {
        ...
        GetLogs.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.client.GetLogs();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        GetLogs.fromObject = function fromObject(object) {
            if (object instanceof $root.client.GetLogs)
                return object;
            let message = new $root.client.GetLogs();
            if (object.url != null)
                message.url = String(object.url);
            return message;
        };
    ...
    client.GetStatus = (function() {
        ...
        GetStatus.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.client.GetStatus();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        GetStatus.fromObject = function fromObject(object) {
            if (object instanceof $root.client.GetStatus)
                return object;
            let message = new $root.client.GetStatus();
            if (object.all != null)
                message.all = Boolean(object.all);
            return message;
        };
    ...
    client.Request = (function() {
        ...
        Request.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.client.Request();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        Request.verify = function verify(message) {
            ...
            if (message.getSensorData != null && message.hasOwnProperty("getSensorData")) {
                let error = $root.client.GetSensorData.verify(message.getSensorData);
                if (error)
            ...
            if (message.sensorData != null && message.hasOwnProperty("sensorData")) {
                ...
                for (let i = 0; i < message.sensorData.length; ++i) {
                    let error = $root.client.SensorData.verify(message.sensorData[i]);
                    if (error)
                        return "sensorData." + error;
                }
            }
            if (message.streaming != null && message.hasOwnProperty("streaming")) {
                let error = $root.client.Streaming.verify(message.streaming);
                if (error)
                    return "streaming." + error;
            }
            if (message.control != null && message.hasOwnProperty("control")) {
                let error = $root.client.Control.verify(message.control);
                if (error)
                    return "control." + error;
            }
            if (message.settings != null && message.hasOwnProperty("settings")) {
                let error = $root.client.Settings.verify(message.settings);
                if (error)
                    return "settings." + error;
            }
            if (message.status != null && message.hasOwnProperty("status")) {
                let error = $root.client.Status.verify(message.status);
                if (error)
                    return "status." + error;
            }
            if (message.getStatus != null && message.hasOwnProperty("getStatus")) {
                let error = $root.client.GetStatus.verify(message.getStatus);
                if (error)
                    return "getStatus." + error;
            }
            if (message.playback != null && message.hasOwnProperty("playback")) {
                let error = $root.client.Playback.verify(message.playback);
                if (error)
                    return "playback." + error;
            }
            if (message.getLogs != null && message.hasOwnProperty("getLogs")) {
                let error = $root.client.GetLogs.verify(message.getLogs);
                if (error)
        ...
        Request.fromObject = function fromObject(object) {
            if (object instanceof $root.client.Request)
                return object;
            let message = new $root.client.Request();
            if (object.id != null)
            ...
            if (object.sensorData) {
                ...
                message.sensorData = [];
                for (let i = 0; i < object.sensorData.length; ++i) {
        ...
        Request.toObject = function toObject(message, options) {
            ...
            if (message.sensorData && message.sensorData.length) {
                object.sensorData = [];
                for (let j = 0; j < message.sensorData.length; ++j)
    ...
    client.Response = (function() {
        ...
        Response.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.client.Response();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        Response.fromObject = function fromObject(object) {
            if (object instanceof $root.client.Response)
                return object;
            let message = new $root.client.Response();
    ...
    client.Message = (function() {
        ...
        Message.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.client.Message();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        Message.verify = function verify(message) {
            ...
            if (message.request != null && message.hasOwnProperty("request")) {
                let error = $root.client.Request.verify(message.request);
                if (error)
                    return "request." + error;
            }
            if (message.response != null && message.hasOwnProperty("response")) {
                let error = $root.client.Response.verify(message.response);
                if (error)
        ...
        Message.fromObject = function fromObject(object) {
            if (object instanceof $root.client.Message)
                return object;
            let message = new $root.client.Message();
            switch (object.type) {
            default:
                if (typeof object.type === "number") {
                    message.type = object.type;
